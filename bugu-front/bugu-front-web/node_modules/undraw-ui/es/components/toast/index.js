import { defineComponent as l, useCssVars as p, reactive as m, ref as d, watch as f, onMounted as v, openBlock as i, createElementBlock as g, createVNode as u, Transition as _, withCtx as w, withDirectives as h, createElementVNode as r, createBlock as y, unref as x, createCommentVNode as C, normalizeClass as b, toDisplayString as z, vShow as T } from "vue";
import { UIcon as L } from "undraw-ui";
import { _ as M } from "../anchor/index.js";
import { c as B, r as N } from "../../util/dom.js";
import { m as k } from "../../util/basic.js";
...
const V = { class: "v-toast" }, A = { class: "inner" }, D = { class: "message" }, E = /* @__PURE__ */ l({
  name: "UToast",
  __name: "index",
  props: {
    message: { default: "" },
  ...
  setup(e) {
    ...
    const o = m(c("normal").options), n = d(!1);
    return f(
      () => t.type,
      (s) => {
        const a = c(s);
        a && (o.color = a.options.color, o.bgColor = a.options.bgColor, o.icon = a.options.icon);
      },
      { immediate: !0 }
    ), v(() => {
...
const H = /* @__PURE__ */ M(E, [["__scopeId", "data-v-684fcd13"]]);
function G(e) {
  if (!e.message)
    return;
  k(e, {
  ...
  const { vnode: t, container: o } = B(H, e);
  return setTimeout(() => {
    N(o);
  }, e.duration + 300), t;
}
