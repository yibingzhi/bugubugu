...
export declare const UChat: {
    new (...args: any[]): {
        ...
        $props: {
            ...
            readonly config: import("./chat.vue").ChatConfigApi;
        ...
        $emit: ((event: "submit", val: any, finish: Function) => void) & ((event: "load-more", finish: (val: any[]) => void) => void);
        $el: any;
        $options: import("vue").ComponentOptionsBase<Readonly<import("vue").ExtractPropTypes<{
            config: {
                type: import("vue").PropType<import("./chat.vue").ChatConfigApi>;
                required: true;
            };
        }>> & {
            onSubmit?: ((val: any, finish: Function) => any) | undefined;
