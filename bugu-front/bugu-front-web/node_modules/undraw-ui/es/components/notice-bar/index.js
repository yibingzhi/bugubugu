import { defineComponent as W, reactive as w, ref as f, computed as A, onMounted as B, resolveComponent as u, openBlock as o, createElementBlock as a, normalizeStyle as m, createVNode as I, unref as $, withCtx as p, Fragment as N, renderList as R, createBlock as r, createTextVNode as C, toDisplayString as x, createCommentVNode as h, createElementVNode as y, nextTick as S } from "vue";
...
const E = { key: 0 }, U = /* @__PURE__ */ W({
  ...
  setup(v) {
    const n = v, e = w({
      ...
      twoTime: 0,
      order: 1
    }), l = f({}), i = f({}), _ = A(() => n.delay > 2e3 ? n.delay : 2e3), k = () => {
      S(() => {
    ...
    return B(() => {
      ...
      const T = u("el-carousel-item"), c = u("u-icon");
      return o(), a("div", {
        class: "u-notice-bar",
        style: m({ background: t.background, height: `${t.height}px` })
      }, [
...
const L = /* @__PURE__ */ z(U, [["__scopeId", "data-v-f1fabe27"]]), q = L;
export {
  q as U
};
